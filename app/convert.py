...
def main():
    ...
    parser.add_option('--d', dest='nname', type='string', help='specify your raw            directory!')

    parser.add_option('--rext', dest='rawextension', type='choice', default="all", choices = ['all', '.tif', '.tiff', '.bmp', '.jpg', '.png', '.jpeg'], help='the image format to be converted.')

    parser.add_option('--text', dest='targetextension', type='choice', default=".jpg", choices = ['.tif', '.tiff', '.bmp', '.jpg', '.png', '.jpeg'], help='the image format to be used for the converted images.')
